...
public class PersonneRestServives {
	...
	// liste des personne
	@RequestMapping(value="/personnes", method=RequestMethod.GET)// elle nous permet d'avoir le resultat de cette requet par http
	public List<Personnes> getPersonnes(){
		return personnesdao.findAll();
	}
	
	// consulter uune personne
	@RequestMapping(value="/personnes/{idPersonne}", method=RequestMethod.GET)// elle nous permet d'avoir le resultat de cette requet par http
	public Personnes getConPersonnes(@PathVariable Long idPersonne){
		return personnesdao.findOne(idPersonne);
	}
	
	@RequestMapping(value="/personnes/checkLoginPass", method=RequestMethod.GET)// elle nous permet d'avoir le resultat de cette requet par http
	...
	@RequestMapping(value="/personnes/search", method=RequestMethod.GET)// elle nous permet d'avoir le resultat de cette requet par http
	...
	@RequestMapping(value="/personnes", method=RequestMethod.POST)// elle nous permet d'avoir le resultat de cette requet par http
	public Personnes save(@RequestBody Personnes p){
		return personnesdao.save(p);
	}
	
	// supprimer uune personne
	@RequestMapping(value="/personnes/{idPersonne}", method=RequestMethod.DELETE)// elle nous permet d'avoir le resultat de cette requet par http
	public boolean delete(@PathVariable Long idPersonne){
		personnesdao.delete(idPersonne);
		return 	true;
	}
	// update uune personne
	@RequestMapping(value="/personnes/{idPersonne}", method=RequestMethod.PUT)// elle nous permet d'avoir le resultat de cette requet par http
...
/***************************************  TRAJET  PROPOSER******************************/
	@RequestMapping(value="/personnes/saveTrajetProposer", method=RequestMethod.POST)// elle nous permet d'avoir le resultat de cette requet par http
	...
	@RequestMapping(value="/personnes/TrajetProposer/find", method=RequestMethod.GET)// elle nous permet d'avoir le resultat de cette requet par http
	...
	@RequestMapping(value="/personnes/Trajet/list", method=RequestMethod.GET)// elle nous permet d'avoir le resultat de cette requet par http
	...
	@RequestMapping(value="/dosearche", method=RequestMethod.GET)// elle nous permet d'avoir le resultat de cette requet par http
